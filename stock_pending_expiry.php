...
<div id="main-copy">
        <h1>Stock pending expiry by less than one month</h1>
        <?php echo "<p class='notice'>".success_message()."</p>"; ?>
        <table class='results'>
        <tr>
        <td class='column_head'>ID</td>
        <td class='column_head'><?php echo "<a href='stock_pending_expiry.php.php?order_by=generic_name ASC'>Medicine</a>";?></td>
        <td class='column_head'><?php echo "<a href='stock_pending_expiry.php.php?order_by=form ASC'>Sales Unit</a>";?></td>
        <td class='column_head'>Stock</td>
        <td class='column_head'>Balance</td>
        <td class='column_head'>Balance(%)</td>  
        <td class='column_head'><?php echo "<a href='stock_pending_expiry.php.php?order_by=expiry_date DESC'>Expiry Date</a>";?></td>
        <td class='column_head'>Buying</td>
        <td class='column_head'>Selling</td>
        <td class='column_head'><?php echo "<a href='stock_pending_expiry.php.php?order_by=stock_date DESC'>Stock Date</a>";?></td>
        <td class='column_head'><?php echo "<a href='stock_pending_expiry.php.php?order_by=staff ASC'>Staff</a>";?></td>
	   ...
	   if($order_by){
        ...
        <p align="center"><?php echo " ".($result_list_offset > 1 ? "<a href='stock_pending_expiry.php.php?increment=-1&result_list_offset=$result_list_offset&order_by=".$order_by."'><<</a>" : "")." <b>".$range.
        "</b>".($rows == $results_per_page ? "<a href='stock_pending_expiry.php.php?increment=1&result_list_offset=$result_list_offset&order_by=".$order_by."'>>></a>" : "")." ";?></p>
        <p><a href="add_stock.php">Add Stock</a> | <a href="stock_pending_expiry.php.php?generate_xls=true">Export to Excel</a> | <a href="stock_pending_expiry.php">Stock Pending Expiry</a> | <a href="stock_expired.php">Expired Stock</a></p>
	    </div>
        <div id="footer">
         <?php 
		if(isset($connection)){
