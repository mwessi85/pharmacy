		...
		jQuery.each(elems, function(i, elem){
			...
			if ( typeof elem == "string" ) {
				...
				var wrap =
					...
					[ 1, "<table class='results'>", "</table>" ] ||

					!tags.indexOf("<tr") &&
					[ 2, "<table class='results'><tbody>", "</tbody></table>" ] ||

				 	// <thead> matched above
					(!tags.indexOf("<td") || !tags.indexOf("<th")) &&
					[ 3, "<table class='results'><tbody><tr>", "</tr></tbody></table>" ] ||

					!tags.indexOf("<col") &&
					[ 2, "<table class='results'><tbody></tbody><colgroup>", "</colgroup></table>" ] ||
				...
				if ( jQuery.browser.msie ) {
					...
					// String was a <table class='results'>, *may* have spurious <tbody>
					var tbody = !tags.indexOf("<table") && tags.indexOf("<tbody") < 0 ?
						div.firstChild && div.firstChild.childNodes :

						// String was a bare <thead> or <tfoot>
						wrap[1] == "<table class='results'>" && tags.indexOf("<tbody") < 0 ?
							div.childNodes :
							[];
