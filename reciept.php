...
$query = "SELECT * FROM service_sales WHERE transaction_no = '".$transaction_no."'";
$service_result = mysql_query($query, $connection);
...
<table width="747" border="1">
  ...
  <tr>
   ...
   <?php 
   $sum = 0;
   while($services = mysql_fetch_array($service_result)){
	$transaction_no = $sale['transaction_no'];
